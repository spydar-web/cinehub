...
function m(e, t) {
    ...
    for (const e of a) if (!n.includes(e)) return !1;
    return !0;
}
function w(e) {
...
function y(e, t = 1e3, n = 2) {
    const a = t * Math.pow(n, e),
        i = Math.round(0.5 * a * (Math.random() - 0.5) * 2);
...
function C(e) {
    return e !== IDBDatabase.prototype.transaction ||
        ...
        : function (t, ...n) {
              ...
              return D.set(a, t.sort ? t.sort() : [t]), $(a);
          };
}
function O(e) {
...
function $(e) {
    ...
    const t = O(e);
    return t !== e && (k.set(e, t), L.set(t, e)), t;
}
const P = (e) => L.get(e);
...
async function oe(e) {
    ...
    const n = await re(e.appConfig, (n) => {
        const a = (function (e) {
                return le(e || { fid: G(), registrationStatus: 0 });
            })(n),
            i = (function (e, t) {
                if (0 === t.registrationStatus) {
                    ...
                    const n = {
                        ...
                        a = (async function (e, t) {
                            try {
                                ...
                                throw (
                                    (R(n) && 409 === n.customData.serverCode
                                        ? await ie(e.appConfig)
                                        : await ae(e.appConfig, {
                                              fid: t.fid,
                    ...
                    return { installationEntry: n, registrationPromise: a };
                }
                return 1 === t.registrationStatus
                    ? { installationEntry: t, registrationPromise: se(e) }
                    : { installationEntry: t };
            })(e, a);
...
async function se(e) {
    ...
    for (; 1 === t.registrationStatus; )
        await W(100), (t = await ce(e.appConfig));
    if (0 === t.registrationStatus) {
        const { installationEntry: t, registrationPromise: n } = await oe(e);
        return n || t;
    }
    return t;
}
...
async function ue({ appConfig: e, heartbeatServiceProvider: t }, n) {
    const a = (function (e, { fid: t }) {
            return `${x(e)}/${t}/authTokens:generate`;
        })(e, n),
        i = z(e, n),
        r = t.getImmediate({ optional: !0 });
    if (r) {
    ...
    const o = { installation: { sdkVersion: "w:0.6.4", appId: e.appId } },
            ...
            return (
                (n = (async function (e, t) {
                    ...
                    for (; 1 === n.authToken.requestStatus; )
                        await W(100), (n = await fe(e.appConfig));
                    const a = n.authToken;
...
async function he(e, t = !1) {
    ...
    await (async function (e) {
        const { registrationPromise: t } = await oe(e);
        t && (await t);
    })(n);
...
const me = (e) => {
    ...
    return {
        getId: () =>
            (async function (e) {
                const t = e,
                    { installationEntry: n, registrationPromise: a } = await oe(
                        t
                    );
                return (
                    a ? a.catch(console.error) : de(t).catch(console.error),
                    n.fid
                );
            })(a),
        getToken: (e) => he(a, e),
...
t(
        ...
        (e) => {
            const t = e.getProvider("app").getImmediate(),
                a = (function (e) {
                    ...
                    for (const n of t) if (!e.options[n]) throw ge(n);
                    return {
                        appName: e.name,
    ...
    t(new I("installations-internal", me, "PRIVATE")),
    e(N, "0.6.4"),
    e(N, "0.6.4", "esm2017");
...
function Ie(e) {
    if (!e.startsWith(we)) {
        const t = ve.create("invalid-gtag-resource", { gtagURL: e });
        return ye.warn(t.message), "";
    }
    return e;
}
function be(e) {
...
function Ee(e, t) {
    const n = (function (e, t) {
        ...
        })("firebase-js-sdk-policy", { createScriptURL: Ie }),
        a = document.createElement("script"),
        i = `${we}?l=${e}&id=${t}`;
    (a.src = n ? (null == n ? void 0 : n.createScriptURL(i)) : i),
        (a.async = !0),
...
function Te(e, t, n, a) {
    return async function (i, ...r) {
        try {
            if ("event" === i) {
                const [a, i] = r;
                await (async function (e, t, n, a, i) {
                    try {
                        let r = [];
                        if (i && i.send_to) {
                            let e = i.send_to;
                ...
                const [i, o] = r;
                await (async function (e, t, n, a, i, r) {
                    const o = a[i];
                    try {
                        if (o) await t[o];
                        else {
                            const e = (await be(n)).find(
                                (e) => e.measurementId === i
                            );
                            e && (await t[e.appId]);
                        }
...
async function ke(e, t = Se, n) {
    const { appId: a, apiKey: i, measurementId: r } = e.options;
    if (!a) throw ve.create("no-app-id");
    if (!i) {
        if (r) return { measurementId: r, appId: a };
        throw ve.create("no-api-key");
    }
    ...
    return (
        ...
        Le({ appId: a, apiKey: i, measurementId: r }, o, s, t)
    );
}
async function Le(e, { throttleEndTimeMillis: t, backoffCount: n }, a, i = Se) {
    var r;
    ...
    try {
        ...
        if (
            ...
            if ((i.deleteThrottleMetadata(o), s))
                return (
                    ye.warn(
        ...
        const l =
                503 ===
                Number(
                    null === (r = null == c ? void 0 : c.customData) ||
                        void 0 === r
                        ? void 0
                        : r.httpStatus
                )
                    ? y(n, i.intervalMillis, 30)
                    : y(n, i.intervalMillis),
            u = { throttleEndTimeMillis: Date.now() + l, backoffCount: n + 1 };
        return (
            i.setThrottleMetadata(o, u),
            ye.debug(`Calling attemptFetch again in ${l} millis`),
            Le(e, u, a, i)
        );
    }
}
...
async function _e(e, t, n, a, i, r, o) {
    var s;
    const c = ke(e);
    c
        .then((t) => {
    ...
    const l = (async function () {
            if (!u())
                return (
                    ye.warn(
                        ve.create("indexeddb-unavailable", {
                            errorInfo:
    ...
    return (
        (h.origin = "firebase"),
        (h.update = !0),
        null != p && (h.firebase_id = p),
        i("config", f.measurementId, h),
        Ce && (i("set", Ce), Pe(void 0)),
        f.measurementId
    );
}
class Me {
    ...
    _delete() {
        return delete Ae[this.app.options.appId], Promise.resolve();
    }
}
let Ae = {},
    Be = [];
...
let Fe,
    ...
    qe = !1;
function Ve(e) {
    if (qe) throw ve.create("already-initialized");
    e.dataLayerName && (xe = e.dataLayerName), e.gtagName && (He = e.gtagName);
}
function ze(e, t, n) {
    !(function () {
        const e = [];
        if (
            (l() && e.push("This is a browser extension environment."),
            f() || e.push("Cookies are not available."),
            e.length > 0)
        ) {
            const t = e.map((e, t) => `(${t + 1}) ${e}`).join(" "),
                n = ve.create("invalid-analytics-context", { errorInfo: t });
            ye.warn(n.message);
        }
    })();
    ...
    if (!a) throw ve.create("no-app-id");
    if (!e.options.apiKey) {
        if (!e.options.measurementId) throw ve.create("no-api-key");
        ye.warn(
    ...
    if (null != Ae[a]) throw ve.create("already-exists", { id: a });
    if (!qe) {
        !(function (e) {
            let t = [];
            Array.isArray(window[e]) ? (t = window[e]) : (window[e] = t);
        })(xe);
        const { wrappedGtag: e, gtagCore: t } = (function (e, t, n, a, i) {
            let r = function (...e) {
                window[a].push(arguments);
            };
            return (
                window[i] && "function" == typeof window[i] && (r = window[i]),
                (window[i] = Te(r, e, t, n)),
                { gtagCore: r, wrappedGtag: window[i] }
            );
        })(Ae, Be, Ne, xe, He);
        (Re = e), (Fe = t), (qe = !0);
    }
    Ae[a] = _e(e, Be, Ne, t, Fe, xe, n);
    return new Me(e);
}
function Ue(e = a()) {
    e = v(e);
    const t = n(e, "analytics");
    return t.isInitialized() ? t.getImmediate() : We(e);
}
function We(e, t = {}) {
    ...
    if (a.isInitialized()) {
        ...
        throw ve.create("already-initialized");
    }
    return a.initialize({ options: t });
}
async function Ke() {
    if (l()) return !1;
    if (!f()) return !1;
...
function Ge(e, t, n) {
    (e = v(e)),
        ...
        })(Re, Ae[e.app.options.appId], t, n).catch((e) => ye.error(e));
}
async function Je(e) {
    return (
        (e = v(e)),
        (async function (e, t) {
            ...
            return new Promise((t, a) => {
                e("get", n, "client_id", (e) => {
                    e || a(ve.create("no-client-id")), t(e);
                });
            });
        })(Re, Ae[e.app.options.appId])
    );
}
function Ye(e, t, n) {
    (e = v(e)),
...
function Qe(e, t) {
    (e = v(e)),
        ...
        })(Ae[e.app.options.appId], t).catch((e) => ye.error(e));
}
function Xe(e) {
    Re ? Re("set", e) : Pe(e);
}
function et(e, t, n, a) {
    (e = v(e)),
        ...
        })(Re, Ae[e.app.options.appId], t, n, a).catch((e) => ye.error(e));
}
function tt(e) {
    Re ? Re("consent", "update", e) : $e(e);
}
const nt = "@firebase/analytics";
t(
    new I(
        "analytics",
        (e, { options: t }) =>
        ...
        new I(
            ...
            function (e) {
                try {
                    ...
                    return { logEvent: (e, n, a) => et(t, e, n, a) };
                } catch (e) {
...
export {
    Ue as getAnalytics,
    Je as getGoogleAnalyticsClientId,
    We as initializeAnalytics,
    Ke as isSupported,
    et as logEvent,
    Qe as setAnalyticsCollectionEnabled,
    tt as setConsent,
    Ge as setCurrentScreen,
    Xe as setDefaultEventParameters,
    Ye as setUserId,
    Ze as setUserProperties,
    Ve as settings,
};
